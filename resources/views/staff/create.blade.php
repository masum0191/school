...
<div class="bg-white">
    <div class="row bg-primary p-2">
        <div class="col-sm-6">
                <h3 class="text-white"><i class="fa fa-address-book"></i> Staff</h3>
        </div>
...
<div class="col-sm-6 text-right">
    ...
    {{-- <fieldset>
        ...
        <div class="form-group">
                {!! Form::label('Designation', 'Date of Birth :', ['class' => 'col-sm-2 control-label']) !!}
            <div class="col-sm-6">
                 {!! Form::date('Designation', $value = null, ['class' => 'form-control', 'placeholder' => 'Designation']) !!}
            </div>
        </div>
        <div class="form-group">
                {!! Form::label('date of Birth', 'Gender :', ['class' => 'col-sm-2 control-label']) !!}
            <div class="col-sm-6">
                {!!  Form::select('select', ['S' => 'male', 'L' => 'female'],  'S', ['class' => 'form-control' ]) !!}
            </div>
        </div>
        <div class="form-group">
                {!! Form::label('Gender', 'Religion :', ['class' => 'col-sm-2 control-label']) !!}
            <div class="col-sm-6">
               {!!  Form::text('select', $value = null, ['class' => 'form-control' ]) !!}
            </div>
        </div>


        <div class="form-group">
                {!! Form::label('', 'Joining Date ', ['class' => 'col-sm-2 control-label']) !!}
            <div class="col-sm-6">
                {!! Form::date('Religion', $value = null, ['class' => 'form-control', 'placeholder' => 'Religion']) !!}
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="col-sm-6">
            {!!  Form::select('select', ['S' => 'manager', 'L' => 'staff'],  'S', ['class' => 'form-control' ]) !!}
        </div>
    </div>
         <div class="form-group">
...
<!-- Submit Button -->
        <div class="form-group">
            <div class="col-lg-10 col-lg-offset-2">
                {!! Form::submit('Submit', ['class' => 'btn btn-lg btn-info pull-right','value'=>'add user'] ) !!}
            </div>
        </div>
        {{-- <!-- Password -->
        <div class="form-group">
