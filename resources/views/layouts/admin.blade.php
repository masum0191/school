...
<body class="app header-fixed pace-done sidebar-lg-show">
  ...
  let colvisButtonTrans = '{{ trans('cut') }}'

  let languages = {
    'en': 'https://cdn.datatables.net/plug-ins/1.10.19/i18n/English.json'
  };

  $.extend(true, $.fn.dataTable.Buttons.defaults.dom.button, { className: 'btn btn-primary btn-sm' })
