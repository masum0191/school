...
<div class=" bg-white">
    <div class="row bg-dark">
        <div class="col-6">
                <h3 class="box-title text-white"><i class="fa fa-address-book"></i> Section</h3>
        </div>
...
<div class="col-6 text-right">
    ...
    {{-- <fieldset>
        ...
        <div class="form-group">
                {!! Form::label('name', 'Section  :', ['class' => 'col-sm-2 control-label']) !!}
            <div class="col-sm-6">
        ...
        <div class="form-group">
                {!! Form::label('', 'Capacity  : ', ['class' => 'col-sm-2 control-label']) !!}
            <div class="col-sm-6">
                 {!! Form::email('number', $value = null, ['class' => 'form-control', 'placeholder' => 'Designation']) !!}
            </div>
        </div>
        <div class="form-group">
                {!! Form::label('', 'Class :', ['class' => 'col-sm-2 control-label']) !!}
            <div class="col-sm-6">
...
<!-- Submit Button -->
        <div class="form-group">
            <div class="col-lg-10 col-lg-offset-2">
                {!! Form::submit('Add Section', ['class' => 'btn btn-lg btn-info pull-right'] ) !!}
            </div>
        </div>
        {{-- <!-- Password -->
        <div class="form-group">
